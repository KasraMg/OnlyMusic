...
const artists = [
    { englishName:'mohsen yegane', name: 'محسن یگانه', photo: '../Images/yegane.jpg', text: `محسن یگانه متولد 23 اردیبهشت 1364 در گنبد کاووس، خواننده است . دانشجوی انصرافی لیسانس مهندسی صنایع دانشگاه آزاد در ترم شش است، دو خواهر پزشک و دندانپزشک و یک برادر بنام کمیل دارد، خودش فرزند یکی مانده به آخر خانواده است، مادرش استاد دانشگاه و پدرش محمدرضا یگانه کارمند جهاد، شهید دفاع مقدس است. زمانی که محسن 10 ماهه بود پدرش در 23 اسفندماه 64 در سن 35 سالگی به درجه رفیع شهادت رسید. محسن یگانه اولین ترانه خود را در کنار محسن چاوشی با نام نشکن دلمو با ترانه سرایی و آهنگسازی خودش و تنظیمی از محسن چاوشی اجرا کرد. آلبوم اول او با نام سال کبیسه به صورت زیر زمینی منتشر شد. بعد از این آلبوم محسن یگانه فعالیت خود را با انتشار تک آهنگ ادامه داد؛ ناگفته نماند که اغلب همین تک آهنگ های پخش شده، برای جلوگیری از پراکندگی دور هم جمع می شد و به اسم آلبوم بروی سایت ها قرار می گرفت.` },

    {
        englishName:'ali sorena',    name: ' علی سورنا', photo: '../Images/sorena-390x390.png', text: `
...
در سال ۱۳۳۱ برای نخستین بار صدای محمدرضا شجریان از رادیو خراسان پخش می‌شود. سال ۱۳۳۲ محمدرضا شجریان عنوان شاگرد ممتاز را در بین دانش آموزان مشهدی از آن خود می‌کند و سپس در دبیرستان شاهرضا تحصیلات خود را پی می‌گیرد. همزمان در مسابقات فوتبال دبیرستان‌های مشهد هم حضور می‌یابد و در سال ۱۳۳۴ موفق می‌شود به تیم دانش آموزی استان راه یابد.`},
    ...
    { englishName:'ali yasini', name: 'علی یاسینی', photo: '../Images/Ali-Yasini.jpg', text: `علی یاسینی متولد ۱۴ آذر ۱۳۷۵ در تهران، خواننده می باشد. فارغ التحصیل لیسانس رشته معماری می باشد که با گیتار موسیقی را شروع کرد و حالا بعنوان آهنگساز و ترانه سرا بسیار پر طرفدار شده است. یاسینی در یک خانواده ۴ نفره با یک خواهر، بزرگ شده است و فعالیت خود را از از سال ۱۳۸۷ وقتی ۱۲ ساله بود با یادگیری گیتار شروع کرد.` },
